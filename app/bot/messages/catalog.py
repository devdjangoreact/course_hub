...
_MESSAGES: dict[str, dict[str, str]] = {
    "uk": {
        ...
        "pay_button": "Оплатити",
        "promo_materials": "Рекламні матеріали",
        "promo_email_button": "Реклама на email",
        "promo_unavailable": "Рекламні матеріали тимчасово недоступні.",
        "promo_email_sent": "Рекламний опис надіслано на email.",
        "promo_email_missing": "Спочатку збережіть email через оформлення замовлення.",
    ...
    "en": {
        ...
        "promo_email_button": "Promo by email",
        "promo_unavailable": "Promo materials are temporarily unavailable.",
        "promo_email_sent": "Promo description sent to your email.",
        "promo_email_missing": "Save an email first via the order flow.",
